...
var vm = new Vue({
    data: {
        patterns: [{
            ...
            生产厂家中文全称: '化工让生活更美有限公司',
            生产厂家英文全称: 'Chemicals Makes Life Better Co., Ltd.',
            联系方式: '生产工厂地址',
            联系电话: '业务员电话',
            联系人: '业务员姓名',
            走代理: 'N',
            ...
            紧急情况概述: '白色无臭粉末\n吞咽可能有害\n造成严重眼刺激\n向到现场的医生出示sds.',
            信号词: '警告',
            GHS分类: '急性毒性, 经口(类别 5), H303\n严重眼睛损伤/眼睛刺激性(类别 2A), H319',
            爆炸弹: 'N',
            火焰: 'N',
            圆圈上方火焰: 'N',
            高压气瓶: 'N',
            ...
            环境危害: 'N',
            GHS健康危害: 'H303 吞咽可能有害\n H319 造成严重眼刺激',
            GHS物理危害: '目前掌握信息,没有物理或化学的危险性',
            GHS环境危害: '目前掌握信息,没有环境的危害',
            GHS预防措施: 'P264  作业后彻底清洗皮肤\nP280  戴防护眼罩/戴防护面具',
            GHS事故响应: 'P305 + P351 + P338 如进入眼睛:用水小心冲洗几分钟.如戴隐形眼镜并可方便地取出,取出隐形眼镜.继续冲洗\nP312  如感觉不适,呼叫急救中心/医生\nP337 + P313  如仍觉眼刺激:求医/就诊',
            GHS存储: '无特别要求',
            GHS废弃处置: '无特别要求',
            洗眼器: 'Y',
            淋浴器: 'Y',
            ...
            紧急情况概述: '无色无臭的液体\n 可能腐蚀金属\n 造成严重皮肤灼伤和眼损伤\n对水生生物有害\n向到现场的医生出示sds.',
            信号词: '危险',
            GHS分类: '金属腐蚀物(类别 1), H290\n皮肤腐蚀/刺激(类别 1A), H314\n严重眼睛损伤/眼睛刺激性(类别 1), H318\n急性(短期)水生危害(类别 3), H402',
            爆炸弹: 'N',
            火焰: 'N',
            圆圈上方火焰: 'N',
            高压气瓶: 'N',
            ...
            健康危害: 'N',
            环境危害: 'N',
            GHS健康危害: 'H314  造成严重皮肤灼伤和眼损伤\nH318  造成严重眼损伤',
            GHS物理危害: 'H290  可能腐蚀金属',
            GHS环境危害: 'H402  对水生生物有害',
            GHS预防措施: 'P234  只能在原容器中存放\nP264  作业后彻底清洗皮肤\nP273  避免释放到环境中\nP280  戴防护手套/穿防护服/戴防护眼罩/戴防护面具',
    ...
    methods: {
        ...
        selectPattern: function selectPattern(pattern) {
            ...
            if (pattern.防护面具 === 'Y') {
                pattern.gyp防护面具 = '../image/faceprotection.svg';
